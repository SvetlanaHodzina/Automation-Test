...
public class PricingCalculatorPage extends AbstractPage {
    ...
    public final String NUMBER_INSTANCES_XPATH = "//input[@id='input_66']";
    ...
    public final String SERIES_ELEMENT_XPATH = "//div[@id='select_container_92']//md-option//div[1][contains(text(),'%s')]";

    public final String MENU_BUTTON_MACHINETYPE_XPATH = "//md-select[@id='select_93']";
    public final String MACHINETYPE_ELEMENT_XPATH = "//div[@id='select_container_94']//md-option//div[1][contains(text(),'%s')]";
    ...
    public final String NUMBER_GPU_ELEMENT_XPATH = "//div[@id='select_container_428']//md-option//div[1][contains(text(),'%s')]";

    public final String MENU_BUTTON_TYPE_GPU_XPATH = "//md-select-value[@id='select_value_label_426']";
    public final String TYPE_GPU_ELEMENT_XPATH = "//div[@id='select_container_430']//md-option//div[1][contains(text(),'%s')]";

    public final String MENU_BUTTON_LOCAL_SSD_XPATH = "//md-select-value[@id='select_value_label_387']";
    public final String LOCAL_SSD_ELEMENT_XPATH = "//div[@id='select_container_389']//md-option//div[1][contains(text(),'%s')]";

    public final String MENU_BUTTON_LOCATION_XPATH = "//md-select-value[@id='select_value_label_64']";
    public final String LOCATION_ELEMENT_XPATH = "//div[@id='select_container_96']//md-option//div[1][contains(text(),'%s')]";

    public final String MENU_BUTTON_USAGE_XPATH = "//md-select-value[@id='select_value_label_65']";
    public final String USAGE_ELEMENT_XPATH = "//div[@id='select_container_103']//md-option//div[1][contains(text(),'%s')]";
    ...
    public void inputNumberOfInstances(String instances) {
    ...
    public void inputVMClass(String vmClass) {
        new WebDriverWait(driver, ofSeconds(this.WAIT_TIMEOUT_SECONDS))
    ...
    public void inputSeries(String series) {
        new WebDriverWait(driver, ofSeconds(this.WAIT_TIMEOUT_SECONDS))
    ...
    public void inputMachineType(String machineType) {
        new WebDriverWait(driver, ofSeconds(this.WAIT_TIMEOUT_SECONDS))
    ...
    public void inputNumberOfGPUs(String numberGPU) {
        new WebDriverWait(driver, ofSeconds(this.WAIT_TIMEOUT_SECONDS))
    ...
    public void inputTypeOfGPUs(String typeGPU) {
        new WebDriverWait(driver, ofSeconds(this.WAIT_TIMEOUT_SECONDS))
    ...
    public void inputLocalSSD(String localSSD) {
        new WebDriverWait(driver, ofSeconds(this.WAIT_TIMEOUT_SECONDS))
    ...
    public void inputDataCentreLocation(String dataCentreLocation) {
        new WebDriverWait(driver, ofSeconds(this.WAIT_TIMEOUT_SECONDS))
    ...
    public void inputCommittedUsage(String usage) {
        new WebDriverWait(driver, ofSeconds(this.WAIT_TIMEOUT_SECONDS))
    ...
    public void calculateTotalEstimationMonthlyCost() {
    ...
    public void sendEmailForEstimationCost() {
        goToIframe();
        new WebDriverWait(driver, ofSeconds(this.WAIT_TIMEOUT_SECONDS))
